...
const mockAuth: jest.Mock<any, any> = auth as any;
const mockQuery: jest.Mock<any, any> = conn.query as any;
const mockRevalidatePath: jest.Mock<any, any> = revalidatePath as any;
