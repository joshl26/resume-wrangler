// Description: Page component for editing an organization entry in the dashboard.
// file: app/(dashboard)/dashboard/organizations/[id]/edit/page.tsx

import { getUser, fetchOrganizationById } from "@/app/lib/data";
...
export default async function Page({
      ...
      <main className="w-full max-w-3xl mx-auto p-6">
        ...
        <div className="rounded-lg bg-white dark:bg-gray-800 p-6 shadow-md text-center">
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            You must be signed in to edit organization details.
          </p>
          <a
            href="/signin"
  ...
  // Verify the organization entry belongs to the authenticated user
  ...
  const breadcrumbItems = [
    ...
    { name: "Edit Organization", url: `/dashboard/organizations/${id}/edit/` },
  ];
