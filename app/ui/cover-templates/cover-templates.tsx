...
const CoverTemplates = ({
  ...
  return (
    <div className="h-full overflow-y-auto w-full ">
      <div className="flex flex-row max-w-(--breakpoint-lg) m-auto bg-rose-300 tight-shadow pt-[15vh]">
        <h1 className="text-3xl font-bold text-center w-full pb-16">
          Start off with one of our curated cover templates
        </h1>
      </div>
      <div className="flex flex-row flex-wrap gap-10 px-14 pb-20 max-w-(--breakpoint-lg) m-auto bg-rose-300 w-full justify-around">
