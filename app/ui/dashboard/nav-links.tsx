      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              "flex h-[40px] tight-shadow grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-amber-50 hover:text-amber-600 md:flex-none md:justify-start md:p-2 md:px-3",
              {
                "bg-amber-100 text-amber-500": pathname === link.href,
              }
            )}
          >
