...
export const metadata: Metadata = {
  title:
    "Resume Wrangler - AI-Powered Resume & Cover Letter Builder | Free Tool",
  description:
  ...
  openGraph: {
    ...
    description:
      "Tame your job search in seconds. Create ATS-friendly resumes and tailored cover letters with AI. Try it FREE!",
  ...
  twitter: {
    ...
    description:
      "Tame your job search in seconds. Create ATS-friendly resumes with AI. Try FREE!",
...
function HomeStructuredData() {
  ...
  const howToSchema = {
    ...
    description:
      "Step-by-step guide to creating an optimized resume using Resume Wrangler",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
  ...
  const productSchema = {
    ...
    description:
      "AI-powered resume and cover letter builder with ATS optimization",
    brand: {
      "@type": "Brand",
      name: "Resume Wrangler",
    },
