...
export const metadata: Metadata = {
  ...
  description: 'Create tailored resumes and cover letters with AI-powered customization. Resume Wrangler helps job seekers optimize their applications with ATS-friendly templates and smart algorithms.',
  keywords: [
    'resume builder',
  ...
  openGraph: {
    ...
    description: 'Create tailored resumes and cover letters with AI-powered customization. Optimize your job applications with ATS-friendly templates.',
  ...
  twitter: {
    ...
    title: 'Resume Wrangler - AI-Powered Resume & Cover Letter Builder',
    description: 'Create tailored resumes and cover letters with AI-powered customization.',
...
function StructuredData() {
  const organizationSchema = {
    ...
    "description": "AI-powered resume and cover letter customization tool for job seekers",
    "url": `${process.env.DEPLOYMENT_URL}/`,
    ...
    "offers": [
      {
        ...
        "priceCurrency": "USD",
        "name": "Basic Plan",
        "description": "Free membership with customized cover letters and resumes"
      },
      {
        "@type": "Offer",
        "price": "TBD",
        "priceCurrency": "USD",
        "name": "Pro Plan",
        "description": "Premium features with enhanced templates and download limits"
      }
    ],
    "aggregateRating": {
  ...
  const personSchema = {
    ...
    "description": "Creator of Resume Wrangler, an AI-powered resume and cover letter customization tool",
    "alumniOf": {
