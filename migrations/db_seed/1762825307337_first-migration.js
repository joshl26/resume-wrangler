...
`,
  ...
  pgm.createTable("cover_letters", {
    ...
    recipient_title: {
      type: "text",
      default: "'Software Team Hiring Manager'",
    },
    intro_text_start: {
      type: "text",
      default:
    ...
    intro_text_end: {
      type: "text",
      default:
        "'This role appears to be an exciting opportunity where my skill set would prove to be a valuable addition to your company.'",
    },
    salutation_text: { type: "text", default: "'Regards'" },
    conclusion_text: {
      type: "text",
      default:
        "'In addition to the skills mentioned above, I have a solid educational foundation which includes a Bachelor’s Degree in Engineering Technology from McMaster University and an Advanced Diploma in Engineering Technology from Mohawk College.'",
    },
    thanks_text: {
      type: "text",
      default: "'Thank you for your time and consideration.'",
    },
    user_id: { type: "uuid" },
    updated_at: {
      type: "timestamptz",
  ...
  pgm.addConstraint(
    ...
    "cover_experience_lines_cover_letter_id_fkey",
    {
      foreignKeys: {
  ...
  pgm.addConstraint(
    "cover_experience_lines",
    "cover_experience_lines_cover_experience_id_fkey",
    {
      foreignKeys: {
  ...
  pgm.addConstraint(
    "cover_experience_lines",
    "cover_experience_lines_user_id_fkey",
    {
      foreignKeys: {
        columns: "user_id",
        references: "users(id)",
  ...
  pgm.addConstraint(
    "resume_lines",
    "resume_lines_user_custom_section_one_id_fkey",
    {
      foreignKeys: {
  ...
  pgm.addConstraint(
    "resume_lines",
    "resume_lines_user_custom_section_two_id_fkey",
    {
      foreignKeys: {
  ...
  pgm.addConstraint(
    ...
    "selected_application_application_id_fkey",
    {
      foreignKeys: {
        columns: "application_id",
        references: "applications(id)",
  ...
  pgm.addConstraint(
    ...
    "user_custom_section_one_user_id_fkey",
    {
      foreignKeys: {
        columns: "user_id",
        references: "users(id)",
  ...
  pgm.addConstraint(
    ...
    "user_custom_section_two_user_id_fkey",
    {
      foreignKeys: {
        columns: "user_id",
        references: "users(id)",
  ...
  pgm.addConstraint(
    ...
    "user_work_experience_user_id_fkey",
    {
      foreignKeys: {
        columns: "user_id",
        references: "users(id)",
...
exports.down = (pgm) => {
  ...
  pgm.dropConstraint("applications", "applications_company_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("applications", "applications_user_id_fkey", {
    ifExists: true,
  });
  ...
  pgm.dropConstraint("cover_experiences", "cover_experiences_user_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("cover_letters", "cover_letters_company_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("cover_letters", "cover_letters_application_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("cover_letters", "cover_letters_user_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("resume_experiences", "resume_experiences_user_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("resume_lines", "resume_lines_resume_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("resume_lines", "resume_lines_user_education_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("resume_lines", "resume_lines_work_experience_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("resume_lines", "resume_lines_user_skills_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint(
    "resume_lines",
  ...
  pgm.dropConstraint("resume_lines", "resume_lines_user_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("resumes", "resumes_application_id_fkey", {
    ifExists: true,
  });
  ...
  pgm.dropConstraint("user_education", "user_education_user_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint("user_skills", "user_skills_user_id_fkey", {
    ifExists: true,
  });
  pgm.dropConstraint(
    "user_work_experience",
